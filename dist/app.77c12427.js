...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/components/todo.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$TodoApp$init = function (flags) {
	return _Utils_Tuple2(
		{inputValue: '', todos: _List_Nil},
		elm$core$Platform$Cmd$none);
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$TodoApp$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var author$project$TodoApp$ClearInput = {$: 'ClearInput'};
...
var author$project$TodoApp$clearInputValue = function (m) {
	return A2(
		elm$core$Task$perform,
...
var author$project$TodoApp$clearTodoByIndex = function (_n0) {
	var index = _n0.a;
	var todoList = _n0.b;
	var clearByIndex = function () {
		var notMatch = function (item) {
			return !_Utils_eq(index, item.index);
		};
		return A2(elm$core$List$filter, notMatch, todoList);
	}();
	return clearByIndex;
};
		...
		switch (message.$) {
			...
			case 'ClearInput':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'AddTodo':
				var appendItemIntoList = A2(
					elm$core$List$append,
					model.todos,
					_List_fromArray(
						[
							{
							index: elm$core$List$length(model.todos),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{todos: appendItemIntoList}),
					author$project$TodoApp$clearInputValue(author$project$TodoApp$ClearInput));
			default:
				var index = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							todos: author$project$TodoApp$clearTodoByIndex(
								_Utils_Tuple2(index, model.todos))
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$TodoApp$AddTodo = {$: 'AddTodo'};
var author$project$TodoApp$InputValue = function (a) {
	return {$: 'InputValue', a: a};
};
var author$project$TodoApp$ClearTodo = function (a) {
...
var author$project$TodoApp$viewTodoList = function (todolist) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$TodoApp$ClearTodo(item.index))
								]),
							_List_fromArray(
								[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$name('input1'),
						elm$html$Html$Attributes$placeholder('Input something'),
						elm$html$Html$Events$onInput(author$project$TodoApp$InputValue)
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$TodoApp$AddTodo)
					]),
				_List_fromArray(
					[
			...
			return A2(
				...
				function (inputValue) {
					return elm$json$Json$Decode$succeed(
						{inputValue: inputValue, todos: todos});
				},
				A2(elm$json$Json$Decode$field, 'inputValue', elm$json$Json$Decode$string));
		},
		A2(
			elm$json$Json$Decode$field,
			'todos',
			elm$json$Json$Decode$list(
				A2(
					...
					A2(elm$json$Json$Decode$field, 'value', elm$json$Json$Decode$string))))))({"versions":{"elm":"0.19.0"},"types":{"message":"TodoApp.Msg","aliases":{},"unions":{"TodoApp.Msg":{"args":[],"tags":{"InputValue":["String.String"],"ClearInput":[],"AddTodo":[],"ClearTodo":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
var _todo = require("../components/todo.elm");

_todo.Elm.TodoApp.init({
...
},{"../components/todo.elm":"src/components/todo.elm"}],"C:/Users/FTL/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/FTL/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/app.js"], null)
